...
SELECT * FROM Animais WHERE (DATE_FORMAT(Data_nascimento, '%m') = '12' AND DATE_FORMAT(Data_nascimento, '%d') BETWEEN '22' AND '31')
OR (DATE_FORMAT(Data_nascimento, '%m') = '01' AND DATE_FORMAT(Data_nascimento, '%d') BETWEEN '01' AND '19');